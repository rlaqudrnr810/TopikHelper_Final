        ...
        adding.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(bk[count] && userAnswer[count] == answer[count]) {
                    Intent i = new Intent(One_Solve_Reading_Activity.this, Solution_AddingPopup_Activity.class);
                    startActivityForResult(i, 2);
                }
                else{
                    Toast.makeText(One_Solve_Reading_Activity.this, "Only the correct answerer can register the solution.", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    public void mOnPopupClick(View v){
        ...
        ref.child("읽기").child(arr[count] + "번").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Intent i = new Intent(One_Solve_Reading_Activity.this, Solution_Popup_Activity.class);
                i.putExtra("sol", sol);
